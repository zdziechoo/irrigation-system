...
import pl.ttpsc.irrigation.thing.IrrigationRouterThing;
...
public class IrrigationDeviceClient extends ConnectedThingClient {
	...
	private static final String ROUTERNAME = "IR-Lodz";
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			if (client.waitForConnection(TIMEOUT)) {
				...
				IrrigationRouterThing irrigationRouterThing = new IrrigationRouterThing(ROUTERNAME, "Take an information about router localisation",
						client);
				IrrigationDeviceThing irrigationDeviceThing1 = new IrrigationDeviceThing(THINGNAME_1,
						"Deliver signals from IrrigationDevice thing in ThingWorx composer", client);
				IrrigationDeviceThing irrigationDeviceThing2 = new IrrigationDeviceThing(THINGNAME_2,
						"Deliver signals from IrrigationDevice thing in ThingWorx composer", client);
				IrrigationDeviceThing irrigationDeviceThing3 = new IrrigationDeviceThing(THINGNAME_3,
						"Deliver signals from IrrigationDevice thing in ThingWorx composer", client);
				client.bindThing(irrigationRouterThing);
